...
const generarCardsEnHTML = (arrayDeProductos) => {
  ...
  arrayDeProductos.forEach((producto) => {
      cards += `         <div class="col d-flex justify-content-center mb-4">
           <div class="card shadow mb-1 bg-black rounded" style="width: 20rem;">
             <h5 class="card-title pt-2 text-center text-secondary">${producto.title}</h5>
             <img src="${producto.thumbnail}" class="card-img-top" alt="...">
             <div class="card-body">
               <p class="card-text text-white-50 description">${producto.condition}</p>
